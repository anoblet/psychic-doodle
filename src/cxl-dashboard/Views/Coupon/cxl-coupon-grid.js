  ...
  render() {
    return html`
      <vaadin-grid >
        ...
        <vaadin-grid-filter-column header="Code" resizable path="code"></vaadin-grid-filter-column>
        <vaadin-grid-filter-column header="Amount" resizable path="amount"></vaadin-grid-filter-column>
        <vaadin-grid-filter-column header="Date Created" resizable path="date_created"></vaadin-grid-filter-column>
